...
#ifndef _Custom_SSD1306_H_
#define _Custom_SSD1306_H_
...
*/
class Custom_SSD1306 : public Custom_GFX {
 public:
  // NEW CONSTRUCTORS -- recommended for new projects
  Custom_SSD1306(uint8_t w, uint8_t h, TwoWire *twi=&Wire, int8_t rst_pin=-1,
    uint32_t clkDuring=400000UL, uint32_t clkAfter=100000UL);
  Custom_SSD1306(uint8_t w, uint8_t h, int8_t mosi_pin, int8_t sclk_pin,
    int8_t dc_pin, int8_t rst_pin, int8_t cs_pin);
  Custom_SSD1306(uint8_t w, uint8_t h, SPIClass *spi,
    int8_t dc_pin, int8_t rst_pin, int8_t cs_pin, uint32_t bitrate=8000000UL);

  // DEPRECATED CONSTRUCTORS - for back compatibility, avoid in new projects
  Custom_SSD1306(int8_t mosi_pin, int8_t sclk_pin, int8_t dc_pin,
    int8_t rst_pin, int8_t cs_pin);
  Custom_SSD1306(int8_t dc_pin, int8_t rst_pin, int8_t cs_pin);
  Custom_SSD1306(int8_t rst_pin = -1);
  ...
  void         dim(boolean dim, uint8_t customContrast);
