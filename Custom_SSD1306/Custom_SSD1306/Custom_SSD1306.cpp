...
/*!
    ...
    @note   Call the object's begin() function before use -- buffer
            allocation is performed there!
*/
Custom_SSD1306::Custom_SSD1306(uint8_t w, uint8_t h,
  int8_t mosi_pin, int8_t sclk_pin, int8_t dc_pin, int8_t rst_pin,
  int8_t cs_pin) : Custom_GFX(w, h), spi(NULL), wire(NULL), buffer(NULL),
...
/*!
    ...
    @note   Call the object's begin() function before use -- buffer
            allocation is performed there!
*/
Custom_SSD1306::Custom_SSD1306(uint8_t w, uint8_t h, SPIClass *spi,
  int8_t dc_pin, int8_t rst_pin, int8_t cs_pin, uint32_t bitrate) :
  Custom_GFX(w, h), spi(spi ? spi : &SPI), wire(NULL), buffer(NULL),
...
/*!
    @brief  DEPRECATED constructor for SPI SSD1306 displays, using software
            ...
            one of the SSD1306_* size defines in Custom_SSD1306.h. New
    ...
    @note   Call the object's begin() function before use -- buffer
            allocation is performed there!
*/
Custom_SSD1306::Custom_SSD1306(int8_t mosi_pin, int8_t sclk_pin,
  int8_t dc_pin, int8_t rst_pin, int8_t cs_pin) :
  Custom_GFX(SSD1306_LCDWIDTH, SSD1306_LCDHEIGHT), spi(NULL), wire(NULL),
...
/*!
    ...
    @note   Call the object's begin() function before use -- buffer
            allocation is performed there!
*/
Custom_SSD1306::Custom_SSD1306(int8_t dc_pin, int8_t rst_pin,
  int8_t cs_pin) : Custom_GFX(SSD1306_LCDWIDTH, SSD1306_LCDHEIGHT),
...
/*!
    @brief  DEPRECATED constructor for I2C SSD1306 displays. Provided for
            ...
            defines in Custom_SSD1306.h. New code should NOT use this.
    ...
    @note   Call the object's begin() function before use -- buffer
            allocation is performed there!
*/
Custom_SSD1306::Custom_SSD1306(int8_t rst_pin) :
  Custom_GFX(SSD1306_LCDWIDTH, SSD1306_LCDHEIGHT), spi(NULL), wire(&Wire),
